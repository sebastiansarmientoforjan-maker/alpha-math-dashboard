      ...
      <div className="bg-[#0a0a0a] border border-slate-800 w-full max-w-2xl rounded-3xl relative z-10 shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200">
        ...
        <div className="p-6 border-b border-slate-800 flex justify-between items-center bg-gradient-to-b from-slate-900/50 to-transparent">
          <div>
            ...
            <p className="text-[10px] text-indigo-400 font-bold uppercase tracking-widest mt-1">DRI Command Center V5.2</p>
          </div>
          <button 
            onClick={onClose} 
          ...
          <section>
            ...
            <div className="grid grid-cols-2 gap-3">
              {[
                ...
                { key: 'Esc', action: 'Close modal / Exit selection mode' },
                { key: '← →', action: 'Navigate students in modal' },
                { key: 'Ctrl+A', action: 'Select all visible students (TRIAGE)' },
              ].map(({ key, action }) => (
          ...
          <section>
            ...
            <div className="p-4 bg-slate-900/40 rounded-xl border border-slate-800 space-y-3">
              <p className="text-[11px] text-slate-400">
                In TRIAGE view, click <span className="text-indigo-400 font-bold">"Select Multiple"</span> to enable selection mode.
              </p>
              <ul className="text-[10px] text-slate-500 space-y-1 list-disc list-inside">
                <li>Click checkboxes to select individual students</li>
                <li>Click column header checkbox to select/deselect entire tier</li>
                <li>Use <kbd className="bg-slate-800 px-1 rounded text-indigo-400">Ctrl+A</kbd> to select all visible students</li>
                <li>Export selected students to CSV for analysis</li>
                <li>Press <kbd className="bg-slate-800 px-1 rounded text-indigo-400">Esc</kbd> to exit selection mode</li>
              </ul>
            </div>
          </section>
