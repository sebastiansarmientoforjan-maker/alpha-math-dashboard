          ...
          <div className="col-span-8 bg-slate-900/20 rounded-[2.5rem] border border-slate-800 p-8">
            <ResponsiveContainer width="100%" height={280}>
              <LineChart data={chartData} margin={{ bottom: 20, left: 10 }}>
                ...
                <XAxis dataKey="i" stroke="#475569" fontSize={10} label={{ value: 'Sesiones Recientes', position: 'insideBottom', offset: -10, fill: '#475569', fontSize: 10 }} />
                <YAxis domain={[0, 100]} stroke="#475569" fontSize={10} label={{ value: '% Precisión', angle: -90, position: 'insideLeft', fill: '#475569', fontSize: 10 }} />
